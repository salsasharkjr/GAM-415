...
APortal::APortal()
{
	...
	// Set collision so anything can pass through mesh
...
{
	AFPS415Character* playerChar = Cast<AFPS415Character>(OtherActor);
...
void APortal::SetBool(AFPS415Character* playerChar)
{
	if (playerChar)
	{
